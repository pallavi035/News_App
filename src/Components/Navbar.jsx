...
//   return (
//     <div>
//       <nav class="flex justify-between px-20 py-10 items-center bg-grey-600">
//   <h1 class="text-xl text-black font-bold">HotCoffee</h1>
...
//       <Link to='/' class="font-semibold text-black">Home</Link>
//       <Link to='/articles' class="font-semibold text-black">Articles</Link>
//       <li>
...
const Navbar = () => {
  ...
  <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <div className="flex md:order-2">
      ...
      <button className='bg-amber-600 px-4 py-2 rounded-md hover:bg-amber-400'>Search</button>
      </div>
      </div>
